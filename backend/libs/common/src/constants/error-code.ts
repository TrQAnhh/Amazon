...
export class ErrorCode {
  ...
  static readonly ORDER_ALREADY_CANCELED = new ErrorCode(
    400,
    'Order has already been canceled',
    HttpStatus.BAD_REQUEST,
  );
  static readonly TICKET_ALREADY_COLLECTED = new ErrorCode(
    400,
    'This ticket has already been collected',
    HttpStatus.BAD_REQUEST,
  );
  ...
  static readonly ORDER_PROCESSING = new ErrorCode(
    409,
    'Order is currently being processed for payment',
    HttpStatus.CONFLICT,
  );
  ...
  static readonly TICKET_ALREADY_EXISTED = new ErrorCode(
    409,
    'Discount ticket with given code already exists',
    HttpStatus.CONFLICT,
  );
  ...
  static readonly STRIPE_SERVICE_UNAVAILABLE = new ErrorCode(
    503,
    'Failed to call Stripe Payment Service',
    HttpStatus.SERVICE_UNAVAILABLE,
  );
  static readonly RESOURCE_BUSY = new ErrorCode(
    503,
