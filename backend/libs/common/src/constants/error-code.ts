...
export class ErrorCode {
  ...
  static readonly PRODUCT_NOT_FOUND = new ErrorCode( 404, 'Product with given information does not exist', HttpStatus.NOT_FOUND);
  static readonly ORDER_NOT_FOUND = new ErrorCode(404, 'Order with given information does not exist', HttpStatus.NOT_FOUND);
  ...
  static readonly TOO_MANY_REQUESTS = new ErrorCode(429, 'Too many requests, please try again later', HttpStatus.TOO_MANY_REQUESTS);
  ...
  static readonly EMAIL_SEND_FAILED = new ErrorCode(500, 'Failed to send email', HttpStatus.INTERNAL_SERVER_ERROR);
  ...
  static readonly RESOURCE_BUSY = new ErrorCode(503, 'Resource busy, please try again later', HttpStatus.SERVICE_UNAVAILABLE);
